...
module.exports = function (app, userModel) {
    ...
    app.post("/api/project/login", passport.authenticate('res-manage-app'), login);
    ...
    app.get("/api/project/user/:username", auth, findUserByUsername);
    app.put("/api/project/user/:id", auth, updateUser);
    app.delete("/api/project/user/:id", auth, deleteUser);
    app.get("/api/project/profile/:username", auth, findUserProfileByUsername);


    passport.use('res-manage-app', new LocalStrategy(localStrategy));
